...
hevc_es_video_packetizer_c(generic_reader_c *p_reader,
  ...
  , m_debug_timecodes(   debugging_requested("hevc_es|hevc_es_timecodes"))
  , m_debug_aspect_ratio(debugging_requested("hevc_es|hevc_es_aspect_ratio"))
{
...
hevc_es_video_packetizer_c::handle_delayed_headers() {
  ...
  memory_cptr new_hevcc = m_parser.get_hevcc();
  set_codec_private(new_hevcc->get_buffer(), new_hevcc->get_size());
